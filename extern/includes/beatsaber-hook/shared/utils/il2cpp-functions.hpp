...
class il2cpp_functions {
  public:
    ...
    #endif
    #ifdef UNITY_2021
    API_FUNC(void*, unity_liveness_allocate_struct, (Il2CppClass * filter, int max_object_count, il2cpp_register_object_callback callback, void* userdata, il2cpp_liveness_reallocate_callback reallocate));
